#!/bin/bash
# Multi-turn SFT training script for Qwen 14B model
# This script trains a Qwen 14B model using FSDP (Fully Sharded Data Parallel) strategy
...
torchrun --nnodes=$nnodes --nproc_per_node=$nproc_per_node \
    ...
    trainer.experiment_name=multiturn-sft-qwen-14b-instruct \
